...
<section class="services-style-two" style="padding:80px 0; background:#f9f9f9;">
    <div class="auto-container">
        ...
        <div class="section-title centered" style="text-align:center; margin-bottom:40px;">
            ...
            <span class="title"
                  style="display:inline-block; font-size:14px; color:#0077b5; font-weight:600; letter-spacing:1px;">
                Our Core Services
            </span>
            ...
            <div class="text"
                 style="max-width:700px; margin:0 auto; color:#666; font-size:15px; line-height:1.6;">
        ...
        $services = [
            ...
            [
                "Regulatory Services in UAE & Pakistan",
                "regulatory.jpg",
                "regulatory",
            ...
            //     "advisory.jpg",
            //     "aliyan-swiftedge-advisory",
            //     "Professional business advisory, strategic consulting, compliance, and corporate growth solutions for startups and enterprises."
            // ]
            ...
            <div class="col-lg-4 col-md-6 col-sm-6"
                ...
                <div class="service-block2"
                    ...
                    <div class="image-box">
                        ...
                        <img src="assets/images/service/<?php echo htmlspecialchars($s[1]); ?>"
                             alt="<?php echo htmlspecialchars($s[0]); ?>"
                             style="width:100%;
                                    height:220px;
                                    object-fit:cover;
                                    display:block;">
                    ...
                    <div class="content"
                        ...
                        <p style="font-size:14px;
                            ...
                            <?php echo htmlspecialchars($s[3]); ?>

                        </p>

                        <a href="service-single.php?service=<?php echo urlencode($s[2]); ?>"
                           style="color:#0077b5;
                                  font-weight:600;
