            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <img src="assets/images/logo/bmlogo.png" class="logo" alt="Logo">
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right" data-in="#" data-out="#">
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-menu col-md-3">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    <li><a href="banner-1.html">UAE Mainland Company</a></li>
                                                    <li><a href="banner-2.html">UAE Freezone Company</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="https://www.swiftsignshippingllc.com">Shipping</a></li>
                                <li><a href="https://it.swiftsignbm.com">IT</a></li>
                                <li><a href="https://swiftsigngeneraltrading.com">General Trading</a></li>
                                <li><a href="https://clothandcosmetics.swiftsignbm.com">Cloth and Cosmetics</a></li>
                            </ul>
                        </li>
                        <!-- <li class="dropdown">
